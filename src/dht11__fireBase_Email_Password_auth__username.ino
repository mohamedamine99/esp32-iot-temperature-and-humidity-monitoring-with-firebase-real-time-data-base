...
#define WIFI_SSID "TOPNET_9C18"
#define WIFI_PASSWORD "xxsxhif3pv"

#define API_KEY "AIzaSyCegw-2sw9oZifg1nXl7TkSy6gtMvvrbQA"
/* 3. If work with RTDB, define the RTDB URL */
#define DATABASE_URL "esp32-dht11-fbf8d-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
#define USER_EMAIL "medamine.benabdeljelil.99@gmail.com"
#define USER_PASSWORD "123456"

#define DEVICE_ID "dev-1"
#define SENSOR_ID "DHT-11"
...
{   
    Serial.begin(115200);
    //initializations 
 //  User_name.remove(User_name.indexOf('@'));
       User_name="med";
...
Tempreature_json.add("Sensor Type",SENSOR_ID);
...
Humidity_json.add("Sensor Type",SENSOR_ID);
